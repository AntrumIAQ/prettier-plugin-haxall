...
class LockFile extends sys.Obj {
  ...
  unlock() {
    let fp = sys.ObjUtil.as(((this$) => { let $_u7 = sys.ObjUtil.as(this$.#fpRef.val(), sys.Unsafe.type$); if ($_u7 == null) return null; return sys.ObjUtil.as(this$.#fpRef.val(), sys.Unsafe.type$).val(); })(this), java.failjava.io.RandomAccessFile.type$);
    if (fp != null) {
      fp.close();
    }
    ;
...
class TestRunner extends sys.Obj {
  ...
  runType(type) {
    const this$ = this;
    ((this$) => { let $_u8 = this$.#numTypes;this$.#numTypes = sys.Int.increment(this$.#numTypes); return $_u8; })(this);
    ...
    while (true) {
      if (sys.ObjUtil.equals(mode, Macro.norm())) {
        ...
        if ((sys.ObjUtil.equals(sys.Str.get(this.#pattern, pos), 123) && sys.ObjUtil.equals(sys.Str.getSafe(this.#pattern, sys.Int.plus(pos, 1)), 123))) {
          ...
          resBuf.addChar(sys.Str.get(this.#pattern, ((this$) => { let $_u12 = pos;pos = sys.Int.increment(pos); return $_u12; })(this)));
        }
        ;
      }
      else {
        if (sys.ObjUtil.equals(mode, Macro.inMacro())) {
          ...
          if ((sys.ObjUtil.equals(sys.Str.get(this.#pattern, pos), 125) && sys.ObjUtil.equals(sys.Str.getSafe(this.#pattern, sys.Int.plus(pos, 1)), 125))) {
            ...
            keyBuf.addChar(sys.Str.get(this.#pattern, ((this$) => { let $_u13 = pos;pos = sys.Int.increment(pos); return $_u13; })(this)));
          }
          ;
        }
        else {
...
class AbstractMain extends sys.Obj {
  ...
  static printProps(props,opts) {
    ...
    const this$ = this;
    let out = ((this$) => { let $_u17 = sys.ObjUtil.as(((this$) => { let $_u18 = opts; if ($_u18 == null) return null; return opts.get("out"); })(this$), sys.OutStream.type$); if ($_u17 != null) return $_u17; return sys.Env.cur().out(); })(this);
    let indent = ((this$) => { let $_u19 = ((this$) => { let $_u20 = ((this$) => { let $_u21 = opts; if ($_u21 == null) return null; return opts.get("indent"); })(this$); if ($_u20 == null) return null; return sys.ObjUtil.toStr(((this$) => { let $_u22 = opts; if ($_u22 == null) return null; return opts.get("indent"); })(this$)); })(this$); if ($_u19 != null) return $_u19; return ""; })(this);
    let maxName = 4;
    props.each((v,n) => {
...
class Arg extends sys.Obj {
  ...
  static make$($self,f) {
    ...
    ;
    ((this$) => { let $_u24 = f; if ($_u24 == null) return null; return sys.Func.call(f, this$); })($self);
    return;
  }
...
class Opt extends sys.Obj {
  constructor() {
    ...
    const this$ = this;
    this.#help = "";
    this.#aliases = sys.ObjUtil.coerce(((this$) => { let $_u25 = sys.List.make(sys.Str.type$); if ($_u25 == null) return null; return sys.ObjUtil.toImmutable(sys.List.make(sys.Str.type$)); })(this), sys.Type.find("sys::Str[]"));
    return;
  }
  ...
  static make$($self,f) {
    if (f === undefined) f = null;
    ;
    ((this$) => { let $_u26 = f; if ($_u26 == null) return null; return sys.Func.call(f, this$); })($self);
    return;
  }
  ...
  static parse(s) {
    ...
    if (sys.Str.endsWith(s, ")")) {
      ...
      if (open != null) {
        ...
        if (comma == null) {
          (line = sys.ObjUtil.coerce(((this$) => { let $_u28 = sys.Str.toInt(sys.Str.trim(sys.Str.getRange(s, sys.Range.make(sys.Int.plus(sys.ObjUtil.coerce(open, sys.Int.type$), 1), -2))), 10, false); if ($_u28 != null) return $_u28; return sys.ObjUtil.coerce(0, sys.Int.type$.toNullable()); })(this), sys.Int.type$));
        }
        else {
          (line = sys.ObjUtil.coerce(((this$) => { let $_u29 = sys.Str.toInt(sys.Str.trim(sys.Str.getRange(s, sys.Range.make(sys.Int.plus(sys.ObjUtil.coerce(open, sys.Int.type$), 1), sys.ObjUtil.coerce(comma, sys.Int.type$), true))), 10, false); if ($_u29 != null) return $_u29; return sys.ObjUtil.coerce(0, sys.Int.type$.toNullable()); })(this), sys.Int.type$));
          (col = sys.ObjUtil.coerce(((this$) => { let $_u30 = sys.Str.toInt(sys.Str.trim(sys.Str.getRange(s, sys.Range.make(sys.Int.plus(sys.ObjUtil.coerce(comma, sys.Int.type$), 1), -2))), 10, false); if ($_u30 != null) return $_u30; return sys.ObjUtil.coerce(0, sys.Int.type$.toNullable()); })(this), sys.Int.type$));
        }
        ;
      }
      ;
...
class FileLoggerState extends sys.Obj {
  ...
  out() {
    if ((this.#pattern != null && sys.ObjUtil.compareNE(sys.DateTime.now().toLocale(this.#pattern), this.#curPattern))) {
      ((this$) => { let $_u32 = this$.#curOut; if ($_u32 == null) return null; return this$.#curOut.close(); })(this);
  ...
  open(curFile) {
    ...
    ;
    try {
      ((this$) => { let $_u34 = this$.#logger.onOpen(); if ($_u34 == null) return null; return sys.Func.call(this$.#logger.onOpen(), sys.ObjUtil.coerce(this$.#curOut, sys.OutStream.type$)); })(this);
    }
    catch ($_u35) {
...
class JsonInStream extends sys.InStream {
  ...
  escape() {
    this.expect(92);
    let $_u36 = this.#cur;
    if (sys.ObjUtil.equals($_u36, 98)) {
      this.consume();
      return 8;
    }
    else if (sys.ObjUtil.equals($_u36, 102)) {
      this.consume();
      return 12;
    }
    else if (sys.ObjUtil.equals($_u36, 110)) {
      this.consume();
      return 10;
    }
    else if (sys.ObjUtil.equals($_u36, 114)) {
      this.consume();
      return 13;
    }
    else if (sys.ObjUtil.equals($_u36, 116)) {
      this.consume();
      return 9;
    }
    else if (sys.ObjUtil.equals($_u36, 34)) {
      this.consume();
      return 34;
    }
    else if (sys.ObjUtil.equals($_u36, 92)) {
      this.consume();
      return 92;
    }
    else if (sys.ObjUtil.equals($_u36, 47)) {
      this.consume();
      return 47;
    }
    ;
  ...
  consume() {
    this.#cur = sys.ObjUtil.coerce(((this$) => { let $_u37 = this$.readChar(); if ($_u37 != null) return $_u37; return sys.ObjUtil.coerce(-1, sys.Int.type$.toNullable()); })(this), sys.Int.type$);
    ((this$) => { let $_u38 = this$.#pos;this$.#pos = sys.Int.increment(this$.#pos); return $_u38; })(this);
    return;
  }
  ...
  writeJsonStr(str) {
    ...
    sys.Str.each(str, (char) => {
      if ((sys.ObjUtil.compareLE(char, 127) || !this$.#escapeUnicode)) {
        ...
        else if (sys.ObjUtil.equals($_u39, 34)) {
...
class PathEnv extends sys.Env {
  ...
  static make$($self) {
    ...
    let path = PathEnv.parsePath(null, sys.ObjUtil.coerce(((this$) => { let $_u40 = vars.get("FAN_ENV_PATH"); if ($_u40 != null) return $_u40; return ""; })($self), sys.Str.type$), (msg,err) => {
      this$.#log.warn(sys.Str.plus("Parsing FAN_ENV_PATH: ", msg), err);
      return;
    });
    $self.#vars = sys.ObjUtil.coerce(((this$) => { let $_u41 = vars; if ($_u41 == null) return null; return sys.ObjUtil.toImmutable(vars); })($self), sys.Type.find("[sys::Str:sys::Str]"));
  ...
  static makeProps$($self,file) {
    ...
    let path = PathEnv.parsePath(workDir, sys.ObjUtil.coerce(((this$) => { let $_u42 = props.get("path"); if ($_u42 != null) return $_u42; return ""; })($self), sys.Str.type$), (msg,err) => {
      this$.#log.warn(sys.Str.plus(sys.Str.plus(sys.Str.plus("Parsing ", file.osPath()), ": "), msg), err);
      return;
    });
    $self.#vars = sys.ObjUtil.coerce(((this$) => { let $_u43 = vars; if ($_u43 == null) return null; return sys.ObjUtil.toImmutable(vars); })($self), sys.Type.find("[sys::Str:sys::Str]"));
    $self.#pathRef = concurrent.AtomicRef.make(sys.ObjUtil.coerce(sys.ObjUtil.toImmutable(path), sys.Type.find("sys::File[]")));
    return;
  }
...
class CsvTest extends sys.Test {
  ...
  verifyCsv(src,expected,f) {
    ...
    while (true) {
      ...
      ;
      this.verifyEq(row, expected.get(((this$) => { let $_u47 = i;i = sys.Int.increment(i); return $_u47; })(this)));
    }
    ;
...
class JsonTest extends sys.Test {
  ...
  testUnprintable() {
    ...
    for (let i = 0; sys.ObjUtil.compareLT(i, 32); ((this$) => { let $_u49 = i;i = sys.Int.increment(i); return $_u49; })(this)) {
...
FloatArrayTest.type$ = p.at$('FloatArrayTest','sys::Test',[],{},8192,FloatArrayTest);
IntArrayTest.type$ = p.at$('IntArrayTest','sys::Test',[],{},8192,IntArrayTest);
