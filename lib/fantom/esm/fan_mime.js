...
c("md","text/markdown; charset=utf-8");
c("markdown","text/markdown; charset=utf-8");
c("mp3","audio/mpeg3");
c("mp4","video/mp4");
c("mpeg","video/mpeg");
...
c("wasm","application/wasm");
c("wav","audio/wav");
c("woff","font/woff");
c("woff2","font/woff2");
c("xhtml","application/xhtml+xml");
c("xeto","text/xeto; charset=utf-8");
